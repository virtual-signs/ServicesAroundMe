...
public class inbox extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fragment = inflater.inflate(R.layout.fragment_inbox, container, false);
    ...
    private void setupViewPagerAdapter(ViewPager viewPager) {
        ...
        viewPagerAdapter.addFragment(new inboxReceived(), "Received");
        viewPagerAdapter.addFragment(new inboxSent(), "Sent");
