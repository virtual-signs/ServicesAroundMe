...
public class help extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fragment = inflater.inflate(R.layout.fragment_help, container, false);
    ...
    private void setupViewPagerAdapter(ViewPager viewPager) {
        ...
        viewPagerAdapter.addFragment(new helpTopics(), "Topics");
        viewPagerAdapter.addFragment(new helpContactUs(), "Contact Us");
