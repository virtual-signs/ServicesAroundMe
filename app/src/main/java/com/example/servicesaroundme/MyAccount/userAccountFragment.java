...
public class userAccountFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fragment = inflater.inflate(R.layout.fragment_user_account, container, false);
        tabLayout = fragment.findViewById(R.id.tabLayout1);
        viewPager = (ViewPager)fragment.findViewById(R.id.viewPager1);
        return fragment;
    }
    @Override
    ...
    private void setupViewPagerAdapter(ViewPager viewPager) {
        ...
        viewPagerAdapter.addFragment(new userAccountDeliveryInfo(), "Delivery");
        viewPagerAdapter.addFragment(new userAccountBillingInfo(), "Billing");
