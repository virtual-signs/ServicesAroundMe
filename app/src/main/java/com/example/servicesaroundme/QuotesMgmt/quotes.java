...
public class quotes extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fragment = inflater.inflate(R.layout.fragment_quotes, container, false);
    ...
    private void setupViewPagerAdapter(ViewPager viewPager) {
        ...
        viewPagerAdapter.addFragment(new quotesApproval(), "Approval");
        viewPagerAdapter.addFragment(new quotesActive(), "Active");
        viewPagerAdapter.addFragment(new quotesEnded(), "Ended");
